    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full bg-white/5 border border-white/10 text-white rounded-md h-10 px-3 outline-none focus:ring-2 focus:ring-blue-500"
        >
          {ROLES.map((role) => (
        ...
        <p className="text-xs text-neutral-400">This role will be used to optimize your ATS score and AI suggestions.</p>
      </div>
      ...
      <div className="space-y-2 relative">
        <div className="flex justify-between items-center">
          ...
          <Button variant="ghost" size="sm" className="text-blue-400 hover:text-blue-300 hover:bg-blue-500/10 h-8 px-2">
            <Sparkles className="w-3 h-3 mr-2" /> AI Generate
          </Button>
        </div>
        <Textarea
          id="summary"
